        ...
        try {
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    ...
                    '[Support Server](https://discord.gg/CfxxxVA5SU)\n\n' +
                    'For direct inquiries, contact: **Luffy**\n\n' +
                    'Socials: https://guns.lol/orewa_luffy_54'
                )
                .setTimestamp()
                .setFooter({ text: 'Uta Music Bot • Developed by Luffy' });
